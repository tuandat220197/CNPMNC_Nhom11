window.onload = function () {
	...
	addbanner("~/content/img/banners/banner0.gif", "~/content/img/banners/banner0.gif");
	var numbanner = 9; // số lượng hình banner
	for (var i = 1; i <= numbanner; i++) {
		var linkimg = "~/content/img/banners/banner" + i + ".png";
	...
	for (var c of company) addCompany("~/Content/img/company/" + c, c.slice(0, c.length - 4));
